 ...
 */
class getWorksiteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WorksiteRepository' shared autowired service.
     *
     * @return \App\Repository\WorksiteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WorksiteRepository.php';

        return $container->privates['App\\Repository\\WorksiteRepository'] = new \App\Repository\WorksiteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
