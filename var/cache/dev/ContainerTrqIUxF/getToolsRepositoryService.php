 ...
 */
class getToolsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ToolsRepository' shared autowired service.
     *
     * @return \App\Repository\ToolsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ToolsRepository.php';

        return $container->privates['App\\Repository\\ToolsRepository'] = new \App\Repository\ToolsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
