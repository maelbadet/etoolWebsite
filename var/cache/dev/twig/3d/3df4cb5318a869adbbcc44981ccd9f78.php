...
class __TwigTemplate_413417a3399e074faaaa0080a46a768d extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 12
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 12, $this->source); })()), 'form_start', ["attr" => ["class" => "form"]]);
        echo "
\t\t<div class=\"mb-3\">
\t\t\t";
        // line 14
...
\t\t\t";
        // line 17
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 17, $this->source); })()), "plainPassword", [], "any", false, false, false, 17), 'row', ["label" => "Mot de passe", "attr" => ["class" => "form-control", "placeholder" => "Mot de passe"]]);
        // line 20
        echo "
\t\t</div>
...
";
    ...
    {
        return array (  124 => 27,  117 => 23,  112 => 20,  110 => 17,  104 => 14,  99 => 12,  94 => 10,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t\t<div class=\"mb-3\">
\t\t\t{{ form_row(registrationForm.email, {'attr': {'class': 'form-control', 'placeholder': 'Adresse email'}}) }}
\t\t</div>
\t\t<div class=\"mb-3\">
...
\t</div>
{% endblock %}
", "registration/register.html.twig", "C:\\laragon\\www\\etoolWebiste\\templates\\registration\\register.html.twig");
    }
}
