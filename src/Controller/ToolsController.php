...
class ToolsController extends AbstractController
{
	...
	public function index(Request $request): Response
	{
		...
		if ($form->isSubmitted() && $form->isValid()) {
			...
			$logo = Logo::create(realpath('C:\laragon\www\applicationEtool\etoolWebsite\public\images\etool.png'))
				->setResizeToWidth(50)
			...
			$result->saveToFile('C:\laragon\www\applicationEtool\etoolWebsite\public\images\qrCodeSaver/' . $toolName . '.png');
